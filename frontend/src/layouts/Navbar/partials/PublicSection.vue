      ...
      <router-link custom :to="{ name: menuItem.route }">
        <template v-slot="{ navigate }">
          <div class="menu-wrapper">
            <button
              @click="navigate"
              @mouseover="menuItem.showMenu = true"
...
const showMenuGeneralContent = ref(false);
...
const menuItems = ref([
  ...
  },
  {
    ...
    route: "generalcontent",
    showMenu: showMenuGeneralContent,
    subMenus: [
      { name: "Artists", route: "artistisglobal" },
      { name: "Series", route: "seriesglobal" },
      { name: "Categories", route: "categoriesglobal" },
      { name: "Characters", route: "Charactersglobal" },
    ],
  },
]);
</script>
